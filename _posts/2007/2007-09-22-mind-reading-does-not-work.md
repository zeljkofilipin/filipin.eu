...
I intended to make a page at [Watir wiki](http://wiki.openqa.org/display/WTR/Project+Home) with such information, but never got the time. Well, now that the content is here, creating wiki page is just a minute of work.
...
By the way, the title for this post if from [This Is Your Brain On RST](http://blogs.msdn.com/micahel/archive/2007/01/17/ThisIsYourBrainOnRst.aspx) article by Michael J. Hunter also known as The Braidy Tester.
