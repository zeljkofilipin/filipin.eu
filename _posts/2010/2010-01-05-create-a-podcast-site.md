...
![domains](/assets/create-a-podcast-site/domains-300x224.jpg "domains")

![subdomain](/assets/create-a-podcast-site/subdomain-300x199.jpg "subdomain")
...
![software-services](/assets/create-a-podcast-site/software-services-300x221.jpg "software-services")

![fantastico](/assets/create-a-podcast-site/fantastico-300x217.jpg "fantastico")

![install-wordpress](/assets/create-a-podcast-site/install-wordpress-246x300.jpg "install-wordpress")

Go to [testertested.testingpodcast.com](http://testertested.testingpodcast.com/) and the site is there!

![testertested](/assets/create-a-podcast-site/testertested-300x239.jpg "testertested")
...
![theme](/assets/create-a-podcast-site/theme-300x213.jpg "theme")
...
![Atahualpa](/assets/create-a-podcast-site/Atahualpa-300x212.jpg "Atahualpa")
...
![settings-discussion](/assets/create-a-podcast-site/settings-discussion-300x212.jpg "settings-discussion")
...
![analytics](/assets/create-a-podcast-site/analytics-300x197.jpg "analytics")
...
![Pradeep Soundararajan](/assets/create-a-podcast-site/pradeep.jpg "Pradeep Soundararajan")
...
![itunes1](/assets/create-a-podcast-site/itunes1-300x161.jpg "itunes1")

![itunes2](/assets/create-a-podcast-site/itunes2-300x182.jpg "itunes2")
