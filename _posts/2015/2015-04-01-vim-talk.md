---
tags:  code commons event featured image speaker twitter vim
title: Vim
---
...
![Vim](/assets/2015/vim-talk/vim.png "Vim")
![Emacs](/assets/2015/vim-talk/emacs.png "Emacs")
...
![Editing commit message in Vim](/assets/2015/vim-talk/git-commit-vim.png "Editing commit message in Vim")

The only command-line editor that I was able to use was [nano](https://en.wikipedia.org/wiki/GNU_nano).

![Nano](/assets/2015/vim-talk/nano.png "Nano")
...
![vimtutor normal mode](/assets/2015/vim-talk/vimtutor-normal.png "vimtutor normal mode")
...
![vimtutor insert mode](/assets/2015/vim-talk/vimtutor-insert.png "vimtutor insert mode")
