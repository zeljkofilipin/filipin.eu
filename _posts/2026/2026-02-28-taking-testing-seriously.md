...
I have been reading [James Bach's blog](https://www.satisfice.com/blog) for years, if not decades. The same is true for [Michael Bolton's blog](https://developsense.com/blog). (I met Michael Bolton, not once, but twice\! The first time in [2018](https://filipin.eu/testival-41), the second time in [2025](https://filipin.eu/qa-meetup).)  In late 2025 James Back published a blog post [55 Months, 1 Day](https://www.satisfice.com/blog/archives/487931), announcing his new book. The book is a collaboration with Michael Bolton. (I could not find a blog post announcing the book on Michael Bolton's blog. The only thing I found is [Taking Testing Seriously: The Rapid Software Testing Approach](https://developsense.com/taking-testing-seriously-the-rapid-software-testing-approach).)
...
I have started not one, but two book clubs about the book. One for Testival (see [Testival Meetup \#78](https://filipin.eu/testival-78)), one at work. Each club has met once so far. Both clubs plan to meet at least one more time.
...
I have read it in [2022](https://filipin.eu/testing-computer-software).
...
> Bug reporting is central to testing. (Page 118.)
> ... the quality of your reports is probably the single most important factor in determining your credibility as a tester. (Page 118.)
...
> Considerations for GUI-level Automation. Let's say you are thinking about embarking on automation that will drive the product on a GUI level. Okay. Generally speaking, you ought to be scared of this. (Page 243.)
> Having said that, it's not always a bad idea. (Page 243.)
